(function (window) {
  // Dedicated BTC chart data module (isolated from header ticker logic)
  ...
  function updateChartWithLivePrice(points, latestSample) {
